...
export class CartPage extends BasePage{
    webElements = {
        ...
        nthItemQtyLbl: (pos) => cy.get("[data-test='inventory-item']").eq(pos).get("[data-test='item-quantity'"),
        nthItemNameLbl: (pos) => cy.get("[data-test='inventory-item']").eq(pos).get("[data-test='inventory-item-name'"),
